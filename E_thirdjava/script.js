...
// Preis von 8 Äpfeln
apple = 8;
totalapple = apple * oneapple;
result = totalapple * applePricePerKilo;
console.log(result);
// Preis von 17 Bananen
banana = 17;
totalbanana = banana * onebanana;
result = totalbanana * bananaPricePerKilo;
console.log(result);
// Preis von 1 Tonne Äpfel
apple = 1000;
result = apple * applePricePerKilo;
console.log(result);
// Preis von 1 Tonne Bananen
banana = 1000;
result = banana * bananaPricePerKilo;
console.log(result);